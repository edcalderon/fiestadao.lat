...
const TempoComponent = () => {
  const notifyStoryRenderedArgs = () => {
    const notification = { filepath: '/home/peter/tempo-api/projects/91/fc/91fcfcba-5f3e-4eea-975c-678b7aa456d1/src/components/Governance.tsx', componentName: 'Governance', args };
